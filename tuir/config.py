...
def build_parser():
    ...
    parser.add_argument(
        "-l", dest="link_deprecated", help=argparse.SUPPRESS
    )  # Deprecated, use the positional arg instead
    parser.add_argument(
        "--log",
        metavar="FILE",
        action="store",
    ...
    parser.add_argument(
        "--ascii", action="store_const", const=True, help="Enable ascii-only mode"
    )
    parser.add_argument(
        "--monochrome", action="store_const", const=True, help="Disable color"
    )
    parser.add_argument(
        "--theme",
        metavar="FILE",
